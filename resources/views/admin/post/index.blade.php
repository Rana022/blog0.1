...
<div class="row-fluid sortable ui-sortable">		
				...
				<a href="{{route('admin.post.create')}}" class="btn btn-sm btn-primary pull-right">Add Post</i></a>
						...
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
						  ...
						  <thead>
							  <tr role="row">
                                  ...
                                  <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Username: activate to sort column descending" style="width: 286px;">User</th>
                ...
                <td class="  sorting_1">
                  ...
                  @endif
								...
								<a class="btn btn-info" href="{{route('admin.post.edit',$row->id)}}">
										<i class="halflings-icon white edit"></i>                                            
									</a>

                  <a class="btn btn-info" href="{{route('admin.post.show',$row->id)}}">
