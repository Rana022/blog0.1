...
<div class="row-fluid sortable ui-sortable">		
				...
				<a href="{{route('admin.post.index')}}" class="btn btn-sm btn-primary pull-right">Post</i></a>

					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon user"></i><span class="break"></span>Pending Posts</h2>					
					</div>
