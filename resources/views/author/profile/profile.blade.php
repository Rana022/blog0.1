...
<div class="row-fluid sortable ui-sortable">		
				...
				<a href="{{route('author.profile.edit',$user->id)}}" class="btn btn-sm btn-primary pull-right">Edit Profile</i></a>
                ...
                <img src="{{asset('storage/user/'.$user->image)}}" alt="" width="60px">
								...
								<a class="btn btn-info" href="{{route('author.profile.edit',$user->id)}}">
