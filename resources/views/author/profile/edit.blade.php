...
@section('content')
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<a href="{{route('author.profile')}}" class="btn btn-sm btn-primary pull-right">Profile</i></a>
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Profile</h2>
						
					</div>
					<div class="box-content">
					<form class="form-horizontal" method="post" action="{{route('author.profile.update',$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
						  <fieldset>
